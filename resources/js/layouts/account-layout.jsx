...
import { CreditCard, LogOut, MapPin, Package, ShoppingBag, User } from 'lucide-react';
...
export default function AccountLayout({ children, activeTab = 'orders' }) {
    ...
    const navigation = [
        ...
        { name: 'Cart', href: '/cart', icon: ShoppingBag, key: 'cart' },
    ];
        ...
        <ToastProvider>
            <div className="min-h-screen bg-[var(--color-off-white)]">
                <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-[var(--color-deep-blue)]">My Account</h1>
                        <p className="mt-2 text-[var(--color-brown)]">Manage your orders, payments, and account settings</p>
                    </div>
                        ...
                        <aside className="lg:col-span-1">
                            <nav className="space-y-1 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                                ...
                                <div className="mt-2 border-t border-gray-200 pt-2">
                                    <Link
                                        href="/shop"
                                        className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-[var(--color-brown)] transition-colors hover:bg-gray-100 hover:text-[var(--color-brown)]"
                                    >
