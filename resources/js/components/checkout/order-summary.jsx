                    ...
                    return (
                        <div key={item.cartId} className="flex gap-3">
                            ...
                            <div className="flex-1">
                                <div className="text-[var(--color-deep-blue)] text-sm font-medium">
                                    {item.name}
                                </div>
                                <div className="text-[var(--color-brown)] text-xs">
                                    Qty: {item.quantity || 1}
                                </div>
                                <div className="text-[var(--color-deep-blue)] mt-1 text-sm font-semibold">
